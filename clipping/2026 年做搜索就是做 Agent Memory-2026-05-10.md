...
我最早接触搜索是 2009 年，在惠普实验室（HP Labs）实习，拿 Lucene 做分词，做信息抽取。那时候叫 IE，不是 Internet Explorer，是 Information Extraction。还做了一些 LDA、主题模型这类东西。2009 年贝叶斯那套非常火，跟今天 Transformer 的地位差不多。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJr3UKwbsQOicoBRJsPW06yuFNax88KodzZh0jM6VQibgqMMqDKB9B8Oqzx6BBf4jnmB90tribxpjPiaIEDqQW2KYKuLjvdiaKicduJcE/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJp7z0icffztw5ZQEtwHBSTERXqcojQ7g7ichOP0Ricps0GRQPXia4lJZScaRbko8TRMmbUHVXBtAthBj0xuPxubcgmnXYZ1aalicUcQ/640?wx_fmt=png&from=appmsg)
...
2022 年 11 月 ChatGPT 发布，RAG 起来，搜索和生成越走越近。我 2022 年写过一篇小随笔， **[搜索是过拟合的生成，生成是欠拟合的搜索](https://mp.weixin.qq.com/s?__biz=MzkyODIxMjczMA==&mid=2247495063&idx=1&sn=b2099b1f62810f1fbe2391c83560a402&scene=21#wechat_redirect)** **。** 它们俩其实是对偶的。

2025 年还有一个时间点。春节前正月初一，DeepSeek 发布了 R1，非常火。它那套 reasoning 加 test-time compute 的范式让大家意识到，搜索可以边搜边 reasoning，再不断搜，最后生成一份很长的报告， [这就是 Deep Research](https://mp.weixin.qq.com/s?__biz=MzkyODIxMjczMA==&mid=2247502169&idx=1&sn=1f566cd34d96a5e5dfe810eba2441ed5&scene=21#wechat_redirect) 。2、3 月份 Google、OpenAI、Perplexity 都在做，包括后来做得比较好的 MiroMind。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJq0ksVtibFMJ70oOtfpFLvSmjU9ztKpibjdRiceKwoO6g9Uh91icIs1BJQW20vUfMHbv93mWfOS2YBOicsribkACKeSibvYeqoCsMfPtc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaI18CfY9dJpGIaP7ztTbSK9G3emAfZE8pCA8CcHqqmAOicH39bSawcjPJFxultnupO9iagGB4TDoFOaevEU8YjiaAZvc46Z9zoSF3bQVraA8qE/640?wx_fmt=png&from=appmsg)

[Jina Reranker v3: 全新“列式”重排器，0.6B参数刷新文档检索SOTA](https://mp.weixin.qq.com/s?__biz=MzkyODIxMjczMA==&mid=2247502958&idx=1&sn=ed977dc392b6c387a67da06a01b9512b&scene=21#wechat_redirect)
...
[Jina Reranker V3 是第一个真正意义上的长文本重排器](https://mp.weixin.qq.com/s?__biz=MzkyODIxMjczMA==&mid=2247502958&idx=1&sn=ed977dc392b6c387a67da06a01b9512b&scene=21#wechat_redirect) ，支持 131K 上下文，这篇工作获得了 AAAI 2026 FrontierIR Workshop Best Paper。除此之外我们还有一个 m0 版本，做多模态重排。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqOnTKJAHprJ9ia6ibjDMjwSMIyYP9nqkrw1NA1hAqYJ0hddl7IvAtiaj8v6WuMphRxLLIwDJFGKatyqZHibo2TiaEwC1icFLxeE6QQo/640?wx_fmt=png&from=appmsg)

2026 年今天讨论最多的、你去问智谱、MiniMax 这些厂商，PR 稿里必提的一个词就是：他们的模型如何支持 long-horizon task。长时程任务，就是 Agent 能自主运行多长时间，三四小时、三四天没人管它还能接着干。有个叫 METR 的 Benchmark专门衡量每一个大模型放在一个环境中自主解决任务的最大时间长度。目前大约是 4 到 5 个小时，这个趋势在不断上升。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJrxZaHXgKgGfqU9uqwdelRibSM5fiaUFCkXhOFTw4ia83ynf7b1M6JcY0S0FjYyonvaUCY2XlaibG5aEUz9GpyPCiaLh1nK4TMSpK3M/640?wx_fmt=png&from=appmsg)
...
很多人忽视了在机器学习里最大的一个问题，其实不是方法，而是表征。机器学习的顶会之一 ICLR 的全称就是 International Conference on Learning Representations，表征学习国际会议。顶会以"表征"命名，你就知道这个概念在整个 AI 领域的位置。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJrG9yeJtKQeLGvYDrVY7hDbE8ibUfqeF5XxQTSVd80ic82QPUoJzXDw1eB1nR1pohp4aMayaF0UFTriaAMBglgdcCxTLt758UUwY8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaI18CfY9dJoWwxuKkicfQAK7nt8LAJvpTREqqKj84mRMaibaicrA31oDD93OZNQD176Sg4Dr9PWTicnVT5XPLks8YTnIKtT96FVlfUZH8mDH3Ks/640?wx_fmt=png&from=appmsg)

我们今天从生物学的角度强行关联一下，看一下人是怎么完成记忆的。大家知道这是什么吗？这是刀盾狗（Doge），现在非常火的一个生物。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqicGSLpaxa1qlJDy7eO3jpV8xqnSBEaIyia7Lgic9ymVTtdMuEjHibfQHDY6ibMiavWrCBCj5mvbJ2oFjMibEWCZucDfP2UJVTScwJGA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaI18CfY9dJoo5n4pNvhqTWdp1N95qC1D7JuX3Vs7o0IzgdZHzW0vyf8ul2SG5Dflziae9zHFmnUibefEVtdABbIpgO0tLQeNLOkCSGibOgpWgo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqr3TXHq3qysE6ChFKPQRJAPdfI1ogguEDvwPozkVR3PY8rkEETEPAFVlKGAHd1pqczQjneRHkicZp6CagBcBFNCgqFGRGRoX3k/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqFtX0ONs6GVwuH9s6W6iafswN1s1Woxs6OpYMDNicz0icTyG0j50ShYEwkHyh5gnsxXziczfJmu7RWDJiaIVLUVN8Vpib9B6RX0Tk2w/640?wx_fmt=png&from=appmsg)

这么多产品，怎么区分它们？我用一句话概括： **Source of Truth 在哪？** 这是区分所有记忆产品的第一性原则。沿着这个原则，可以分成三大类：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJpB4hlDsRBwKISiarxUkn3ZTFx2oyhVibgCad11CDOn1icpxQ8ms6IrhRfk4Hqv9GDcAfia8WIOCzdE9yPL4dtlR8FvTicz3228QLEc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqAoHGbdqic2wiceLo0NKsqVIIfw8ib8ibprfNBYtNC6ztff1dSV3BajXEun3xVibq86EyXicbnPILoMcKfYewTcvCBqbgakSC6icJseo/640?wx_fmt=png&from=appmsg)
...
4. **基于时序数据库、知识图谱和向量库做混合检索**
5. **检索完之后你还无法直接呈现到上下文中** ，要解决两个问题：
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJpsuPZw7XHsHzReCy6ZWE8JeOSwDWDFBt7iaEDkK9wDGfgoGY8VG3tLicLOed2uqOhJAcK80SvE0Ticib6103vy5p5t3EbIJhysCgg/640?wx_fmt=png&from=appmsg)
...
除了文件派，还有模型派。 **这是我个人比较看好的方向。** 也许到某个点，大家发现 Transformer 架构本身就把记忆问题解决了，直接 [The bitter Lesson](https://mp.weixin.qq.com/s?__biz=MzkyODIxMjczMA==&mid=2247501872&idx=1&sn=dc3677c0f5ecca56964795c356123bac&scene=21#wechat_redirect) ，力大出奇迹。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/iaI18CfY9dJqG0ZmEgiaXI60lN2Sic77LoccIB3a9mJWnP3yKR3mYNZ0eqibXIj30S3K8fKfItkP0kCGyWSVtibK6cyolfo08HjJmSTyrgAUweEo/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaI18CfY9dJrfLghPEULLCGjTbRlE1iaTTtz6wtyNSehvicVYDsAvJ5eI1BON4XfanzAZRQD3u8GebRDWHYltYcfwF2HdI27ITXLAoBglcqUWc/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaI18CfY9dJrtH8JJa40gcaCfkKY2AicDLV8DTWE0cntVia0asGWMOwgqPLSbUgtVG3sPpxgGD3NGRU8VEVrlwBV4WzvsM5zMouX1e5ia0c2NZ4/640?wx_fmt=png&from=appmsg)
...
| 能力 | Jina + Elastic 怎么覆盖 |
| --- | --- |
| 向量语义检索 | Jina Embeddings v5（677M / 239M） |
| BM25 关键词搜索 | Elasticsearch 原生支持 |
| 稠密 + 稀疏混合 | Elasticsearch 原生 RRF |
| 精排重排序 | Jina Reranker v3（131K 上下文） |
| 网页和文档理解 | Jina Reader |
| 多模态向量化 | Jina Embeddings v4（文本 + 图像 + PDF） |
| 元数据和多租户 | Elasticsearch index / alias |

目前 Elastic 还没覆盖的，是知识图谱遍历，以及如何把大模型放到架构中做事实抽取(extraction)。

Hot Take

**1\. 统一范式还没出现。** 我在做智能体记忆调研的时候发现：其实统一的范式并没有形成。有些人从仿生学角度看这个问题，有些人从自己的使用习惯、工作效率上看这个问题。这非常像 2017 年 Transformer 没出来之前的深度学习，百花齐放的状态，包括 CNN、RNN、LSTM，这些东西百花齐放。
...
3\. Unlearning 是一笔多年的技术债，该还了。 目前所有系统都是只增不减，实际上是一笔技术债。我当时做机器学习的时候，2009 年大家就讨论过机器遗忘(Machine Unlearning)：怎么把已经训练的、已经学到的东西忘掉？一个现实类比就是"刷抖音这号废了，重新开号吧"。推荐系统一旦被污染就无法恢复，本质就是它不会遗忘。智能体记忆面临完全一样的问题：噪声一旦写入，就永久污染所有后续检索。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/2lsubo6ADBMiaTlqOrfVlNpPp1GvHb8VQMqyfbYhb39BTc4XB32iay9icib4txLebALWFdugf8udNrTHRiayiaibLJqYg/640?tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=0)
